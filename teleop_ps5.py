...
LEFT JOYSTICK: Translate right, Left, Up, Down
RIGHT JOYSTICK: Rotate left, Right, Up, Down
L1, L2: Forward/backward
...
try:
    while True:
        ...
        speed_vector[1] = linear_speed_magnitude * axis1  # Up/down

        if joy.get_button(6): # L1 (forward)
            speed_vector[2] = -linear_speed_magnitude
        elif joy.get_button(4): # L2 (backward)
            speed_vector[2] = linear_speed_magnitude
        else:
            speed_vector[2] = 0.0
