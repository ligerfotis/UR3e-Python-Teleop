"""Python code to control UR 6-DOF TCP movement with a keyboard"""
"""Run code as sudo"""
...
# Connect to robot
rtde_control = RTDEControlInterface("192.168.1.223")
...
# Speed parameters
linear_speed_magnitude = 0.15 # m/s
angular_speed_magnitude = 0.20 # rad/s
